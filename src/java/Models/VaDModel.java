...
public class VaDModel {
    ...
    public ArrayList<VaDBean> getBeanList() throws SQLException 
    {
        Connection conn      = null;
        ResultSet resultSet  = null;
        Statement statement  = null;
        ArrayList<VaDBean> listOfVaDBeans = new ArrayList<>();
        ...
        try 
        {
            ...
            while ( resultSet.next() ) 
            {
                ...
                VaDBean VaDBeanObj = new VaDBean();
                
                // Store the Data from the ResultSet in the Bean object.
                VaDBeanObj.setDateAndTime(resultSet.getDate("DateAndTime"));
                VaDBeanObj.setOutletName (resultSet.getString("OutletName"));
                VaDBeanObj.setOutletRef  (resultSet.getInt("OutletRef"));
                VaDBeanObj.setCashSpent  (resultSet.getFloat("CashSpent"));
                
                // Add the Bean object to the list.
                listOfVaDBeans.add(VaDBeanObj);
            }
            
            conn.close();
            return listOfVaDBeans;
        ...
        return null; // DB Conn failed or no data found.
                ...
                //VaDBeanObj.setDateAndTime( resultSet.getDate("DateAndTime") );
                //VaDBeanObj.setOutletRef(
                //VaDBeanObj.setOutletName(
                //VaDBeanObj.setCashSpent(
                
                // Add Bean to the list.
                //listOfBeans.add(VaDBeanObj);